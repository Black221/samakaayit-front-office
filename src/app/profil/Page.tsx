...
const UserData = {
  ...
  post: "Responsable IT Caisse de Sécurité Sociale",
...
function Profil() {
  return (
    <div>
      ...
      <section className='flex w-full gap-[44px] '>
        <div className='flex-1'>
          <h3 className='text-xl font-semibold mb-8'>Informations personnelles</h3>
          <div className=''>
            <form className='grid grid-cols-2 gap-x-[36px] gap-y-3'>
              <div className=''>
        ...
        <div className='shadow-md rounded-[12px] p-5 w-[250px] box-border flex flex-col'>
...
const Dot = () => {
  return <div className='rounded-full border-[5px] border-[#00AF41] bg-[#EAFFF2] absolute w-5 h-5  -start-[11px] ring-0 ring-white '></div>
}
